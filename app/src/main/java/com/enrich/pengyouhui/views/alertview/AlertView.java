package com.enrich.pengyouhui.views.alertview;
...
public class AlertView {
    ...
    public AlertView(String title, String msg, String cancel, String[] destructive,
                     String[] others, Context context, Style style,
    ...
    protected void initViews() {
        ...
        switch (style) {
            case ActionSheet:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.dimen_common_10);
            ...
            case Alert:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.dimen_common_40);
    ...
    protected void initListView() {
        ...
        if (cancel != null && style == Style.Alert) {
            ...
            tvAlert.setBackgroundResource(R.drawable.selector_common_alertview_bottom);
            ...
            for (int i = 0; i < mDatas.size(); i++) {
                ...
                if (i != 0) {
                    ...
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                            (int) context.getResources().getDimension(R.dimen.dimen_common_1),
    ...
    public void setMarginBottom(int marginBottom) {
        int margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.dimen_common_40);
