...
/**
 * @describe 用法： DBHelper dbHelper = new DBHelper(this);
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String PACKAGE_NAME = "com.enrich.pengyouhui";
    // 数据库文件目标存放路径为系统默认位置，com.enrich.pengyouhui 是你的包名
    public static final String DB_PATH = "/data" + Environment.getDataDirectory().getAbsolutePath() + "//" + PACKAGE_NAME + "/"; //
    //    private static String DB_PATH = "/data/data/com.enrich.pengyouhui/databases/";
    /*
     * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
     * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
     * "/arthurcn/drivertest/packfiles/";
     */
    private static String DB_NAME = "pyh_cities.db";
    private static String ASSETS_NAME = "pyh_cities.db";
    ...
    public void createDataBase() throws IOException {
        ...
        //        boolean dbExist = myContext.getDatabasePath(DB_NAME).exists();
        if (dbExist) {
            // 数据库已存在，do nothing.
        } else {
            // 创建数据库
